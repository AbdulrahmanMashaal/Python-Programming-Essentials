...
def pig_latin(word):
    ...
    if (first_letter == "a" or first_letter == "A" or first_letter == "e" or first_letter == "E" or
    first_letter == "i" or first_letter == "I" or first_letter == "o" or first_letter == "O" or first_letter == "u" or first_letter == "U"):
        return(word+"way")
    else:
